...
* support to cloud vendor via https://registry.terraform.io/browse/providers[providers], which have to be downloaded when used
* example: https://registry.terraform.io/providers/hashicorp/aws/latest/docs[Using AWS Provider]

**All examples in this workshop will be executed in us-east-1 to follow along https://www.youtube.com/watch?v=SLB_c_ayRMo[this tutorial]**
