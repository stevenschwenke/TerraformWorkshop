...
* The *module repository* is a library of project-specific resources, for example a "backend-server" implemented with AWS ECS or a "frontend-server" composed out of AWS CloudFront and S3.
